...
public class ApplicationControl {
    ...
    public static void addComponentsToPane(Container pane) {
		...
		lbl_Description.setMinimumSize(new Dimension(600,120));
